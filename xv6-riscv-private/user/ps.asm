...
int main (void) {
   ...
   c:	326080e7          	jalr	806(ra) # 32e <cps>
	exit(0);
  10:	4501                	li	a0,0
  12:	00000097          	auipc	ra,0x0
  16:	274080e7          	jalr	628(ra) # 286 <exit>
...
gets(char *buf, int max)
{
 ...
 108:	19a080e7          	jalr	410(ra) # 29e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 15a:	170080e7          	jalr	368(ra) # 2c6 <open>
  if(fd < 0)
 ...
 16a:	178080e7          	jalr	376(ra) # 2de <fstat>
 16e:	892a                	mv	s2,a0
  close(fd);
 170:	8526                	mv	a0,s1
 172:	00000097          	auipc	ra,0x0
 176:	13c080e7          	jalr	316(ra) # 2ae <close>
  return r;
}
 17a:	854a                	mv	a0,s2
...
0000000000000326 <getsyscallinfo>:
...
putc(int fd, char c)
{
 ...
 354:	f56080e7          	jalr	-170(ra) # 2a6 <write>
}
...
malloc(uint nbytes)
{
 ...
 7aa:	b68080e7          	jalr	-1176(ra) # 30e <sbrk>
  if(p == (char*)-1)
