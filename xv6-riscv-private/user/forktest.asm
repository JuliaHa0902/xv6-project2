...
forktest(void)
{
  ...
  3e:	40650513          	addi	a0,a0,1030 # 440 <cps+0xe>
  ...
  68:	3ec50513          	addi	a0,a0,1004 # 450 <cps+0x1e>
  ...
  b8:	3ec50513          	addi	a0,a0,1004 # 4a0 <cps+0x6e>
  ...
  d4:	3a050513          	addi	a0,a0,928 # 470 <cps+0x3e>
  ...
  ee:	39e50513          	addi	a0,a0,926 # 488 <cps+0x56>
