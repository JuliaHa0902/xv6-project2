...
user/_foo:     file format elf64-littleriscv
...
int main(int argc, char *argv[]) {
  ...
  14:	38a080e7          	jalr	906(ra) # 39a <getpid>
  18:	85aa                	mv	a1,a0
  1a:	00001517          	auipc	a0,0x1
  1e:	83650513          	addi	a0,a0,-1994 # 850 <malloc+0xec>
  22:	00000097          	auipc	ra,0x0
  26:	68a080e7          	jalr	1674(ra) # 6ac <printf>
  2a:	4495                	li	s1,5
...
//			wait(NULL);
  ...
  30:	86c98993          	addi	s3,s3,-1940 # 898 <malloc+0x134>
			printf("Child (pid:%d) created\n", (int) getpid());
  34:	00001a17          	auipc	s4,0x1
  38:	84ca0a13          	addi	s4,s4,-1972 # 880 <malloc+0x11c>
  3c:	05f5e937          	lui	s2,0x5f5e
  40:	10090913          	addi	s2,s2,256 # 5f5e100 <__global_pointer$+0x5f5cfcf>
  44:	a835                	j	80 <main+0x80>
			fprintf(1, "fork failed\n");
  46:	00001597          	auipc	a1,0x1
  4a:	82a58593          	addi	a1,a1,-2006 # 870 <malloc+0x10c>
  4e:	4505                	li	a0,1
  50:	00000097          	auipc	ra,0x0
  54:	62e080e7          	jalr	1582(ra) # 67e <fprintf>
			exit(1);
  58:	4505                	li	a0,1
  5a:	00000097          	auipc	ra,0x0
  5e:	2c0080e7          	jalr	704(ra) # 31a <exit>
			printf("Child (pid:%d) created\n", (int) getpid());
  62:	00000097          	auipc	ra,0x0
  66:	338080e7          	jalr	824(ra) # 39a <getpid>
  6a:	85aa                	mv	a1,a0
  6c:	8552                	mv	a0,s4
  ...
  7a:	fffd                	bnez	a5,78 <main+0x78>
	for (i = 0; i < 5; i++) {
  7c:	34fd                	addiw	s1,s1,-1
  7e:	c09d                	beqz	s1,a4 <main+0xa4>
		int child = fork();
  80:	00000097          	auipc	ra,0x0
  84:	292080e7          	jalr	658(ra) # 312 <fork>
		if (child < 0) {
  88:	fa054fe3          	bltz	a0,46 <main+0x46>
		} else if (child == 0) {
  8c:	d979                	beqz	a0,62 <main+0x62>
			printf("hello, I am parent with (pid:%d)\n", (int) getpid());
  8e:	00000097          	auipc	ra,0x0
  92:	30c080e7          	jalr	780(ra) # 39a <getpid>
  96:	85aa                	mv	a1,a0
  98:	854e                	mv	a0,s3
  9a:	00000097          	auipc	ra,0x0
  9e:	612080e7          	jalr	1554(ra) # 6ac <printf>
...
00000000000003ba <getsyscallinfo>:
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4da:	3f2c8c93          	addi	s9,s9,1010 # 8c8 <malloc+0x164>
 ...
 4e8:	43cb8b93          	addi	s7,s7,1084 # 920 <digits>
 ...
 60e:	2b698993          	addi	s3,s3,694 # 8c0 <malloc+0x15c>
        while(*s != 0){
 612:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 6f0:	24c7b783          	ld	a5,588(a5) # 938 <freep>
 ...
 718:	00e6ea63          	bltu	a3,a4,72c <free+0x4a>
{
 ...
 75a:	1ef73123          	sd	a5,482(a4) # 938 <freep>
}
 75e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 78c:	1b053503          	ld	a0,432(a0) # 938 <freep>
 ...
 7b4:	18890913          	addi	s2,s2,392 # 938 <freep>
  if(p == (char*)-1)
 7b8:	5afd                	li	s5,-1
 7ba:	a895                	j	82e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7bc:	00000797          	auipc	a5,0x0
 7c0:	18478793          	addi	a5,a5,388 # 940 <base>
 7c4:	00000717          	auipc	a4,0x0
 7c8:	16f73a23          	sd	a5,372(a4) # 938 <freep>
 7cc:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7f0:	14a73623          	sd	a0,332(a4) # 938 <freep>
      return (void*)(p + 1);
